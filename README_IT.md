...
10+ contributor attivi e 50+ persone coinvolte a vario titolo. Non per questo
sono inadatti a quelli più piccoli, ma lì potrebbero richiedere qualche
adattamento. Il nostro consiglio: provate le skill così come sono, e adattate
il workflow alle vostre esigenze di volta in volta. Un principio non scala con
la dimensione del progetto, perché non cambia mai: il ruolo di gestire e
orchestrare gli agenti è, e resta, degli umani.
...
**plan-walkthrough** e **pr-walkthrough** rivedono documenti e PR sopra il
...
vita di un progetto; `scripts/wire-machine.sh` automatizza il cablaggio.
...
sul proprio task e nel proprio worktree. Il nostro regime di crociera è circa
...
| doubt-driven-development | addyosmani/agent-skills | orchestrazione standalone e dispatch Codex; rimossi riferimenti a file upstream assenti |
